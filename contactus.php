...
try {
    ...
    $mail->SMTPAuth   = true;
    $mail->Username   = 'icabcic.org@gmail.com';
    $mail->Password   = 'yajo cxjv brkf vxvz'; // App Password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
    $mail->Port       = 587;

    // Email setup to admin
    $mail->setFrom('icabcic.org@gmail.com', 'ICABCIC Enquiry');
    $mail->addAddress('icabcic.org@gmail.com', 'ICABCIC Enquiry');
    ...
    $replyMail->Username   = 'icabcic.org@gmail.com';
    $replyMail->Password   = 'yajo cxjv brkf vxvz';
    $replyMail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
    $replyMail->Port       = 587;

    $replyMail->setFrom('icabcic.org@gmail.com', 'ICABCIC Team');
    $replyMail->addAddress($_POST['email'], $_POST['firstname'] . ' ' . $_POST['secondname']);
    $replyMail->isHTML(true);
    $replyMail->Subject = 'Thank you for your enquiry - ICABCIC 2025';
    ...
    $replyMail->Body = '
        <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
            ...
            <p>Warm regards,<br>ICABCIC 2025 Team</p>
        </div>
    ';
